 ...
 *
 *  屏幕 240x320 (ILI9341, 2.4")，顶部 16px 为状态栏（系统保留，不参与布局），
 *  状态栏以下 240x304 为可配置显示区域（canvas）。Widget 的 x/y/w/h 均为画布内像素坐标。
 */
...
export const CANVAS_HEIGHT = DISPLAY_HEIGHT - STATUS_BAR_HEIGHT // 304
